...
jQuery(document).ready(
    function () {
        ...
        jQuery('body').on(
            'click',
            '#ft_gallery_smart_image_orient_prod',
            function () {
        ...
        jQuery('#ft_gallery_zip_to_woo_model_prod').on(
            'change',
            function (e) {
        ...
        jQuery('#ft_gallery_landscape_to_woo_model_prod').on(
            'change',
            function (e) {
        ...
        jQuery('#ft_gallery_square_to_woo_model_prod').on(
            'change',
            function (e) {
        ...
        jQuery('#ft_gallery_portrait_to_woo_model_prod').on(
            'change',
            function (e) {
                ...
                jQuery.ajax(
                    {
                        ...
                        error: () => {
                            alert('Error, please contact us at https://www.slickremix.com/support/ for helpzzzzz.')
                        }
                    }
                ); // end of ajax()
                return false;
        ...
        jQuery(document).on(
            ...
            () => {
                ...
                FtgPopupClass.PopAjax('ft_gallery_update_image_information_ajax', id , nonce );
            }
        );//End Next Button!
