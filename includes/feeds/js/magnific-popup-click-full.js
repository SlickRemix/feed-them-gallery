jQuery(document).ready(function() {
    ...
    jQuery("body").on("click", "#ftg-photo-prev", function() {
        ...
        e.next(), jQuery(".fts-popup-image-position, .fts-popup-second-half .mfp-bottom-bar").height() < jQuery(".mfp-img").height() ? jQuery(".fts-popup-image-position, .fts-popup-second-half .mfp-bottom-bar").css("height", jQuery(".mfp-img").height()) : jQuery(".fts-popup-second-half .mfp-bottom-bar").css("height", jQuery(".fts-popup-image-position").height())
    }), jQuery("body").on("click", "#ftg-photo-prev, #ftg-photo-next, .fts-facebook-popup .mfp-image-holder .fts-popup-image-position", function(e) {
        ...
        jQuery(".ft-wp-gallery").each(function() {
            ...
            e.each(function() {
                ...
                if (jQuery(e).find("div").hasClass("ft-image-overlay")) var s = jQuery(this).parents(".fts-feed-type-wp_gallery").find(".ft-image-overlay").html();
                else s = "";
                if (jQuery("div").hasClass("fts-mashup-count-wrap")) var i = jQuery(this).parents(".fts-feed-type-wp_gallery").find(".fts-mashup-count-wrap").html();
                else i = "";
                if (jQuery("div").hasClass("ftg-varation-for-popup")) var r = jQuery(this).parents(".fts-feed-type-wp_gallery").find(".ftg-varation-for-popup").html();
                else r = "";
