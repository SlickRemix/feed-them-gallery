...
class Display_Gallery extends Gallery {
    ...
    public function ft_gallery_display_gallery_shortcode($atts) {
        ...
        $grid_width = get_post_meta($ftg['id'], 'ft_gallery_grid_column_width', true);
        ...
        if (is_array($image_list) && isset($image_list[0])) {
            ...
            foreach ($image_list as $image) {
                ...
                if ($format_type == 'post' || $format_type == 'post-in-grid' || $format_type == 'gallery-collage') {
                    ?>
                    <div class="ft-gallery-post-wrap fts-feed-type-wp_gallery ft-post-format <?php if ($format_type == 'gallery-collage') { ?>ft-gallery-collage<?php } ?> ft-gallery-<?php echo $ft_gallery_dynamic_string ?>" style="<?php if ($format_type == 'post-in-grid' || $format_type == 'gallery-collage') { ?>width:<?php print $grid_width ?>;margin:<?php print $space_between_photos ?>;<?php }
                    print $background_color_grid_posts ?>;<?php print $padding; ?> !important;<?php print $border_bottom_color ?>">
                        ...
                        if ($show_share == 'yes' || is_plugin_active('feed-them-gallery-premium/feed-them-gallery-premium.php') && is_plugin_active('woocommerce/woocommerce.php') && isset($productID) && $show_purchase_link == 'yes') { ?>
