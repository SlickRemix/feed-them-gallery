    ...
    jQuery($myListItems).each(function (i) {
        ...
        jQuery.ajaxQueue({
            ...
            success: function (response) {
                ...
                jQuery('#list_item_' + selectedmediacheck).append('<div class="ft-gallery-woo-edit-thumb-btn" style="display: none"><a class="ft_gallery_create_woo_prod_button" target="_blank" href="'+response+'"></a></div>');
...
} // end ft_gallery_image_to_woo


function ft_gallery_image_to_woo_on_upload(imgId, postID){
    ...
    jQuery.ajaxQueue({
        ...
        success: function (response) {
            ...
            jQuery('#list_item_'+imgId).append('<div class="ft-gallery-woo-edit-thumb-btn" style="display: none"><a class="ft_gallery_create_woo_prod_button" target="_blank" href="'+response+'"></a></div>');
            // we hide the .ft-gallery-woo-edit-thumb-btn button above with display:none and then fade it in
            jQuery('.ft-gallery-woo-edit-thumb-btn').fadeIn();
    ...
    return false;
} // end ft_gallery_image_to_woo_on_upload
