<?php
/**
 * FT Gallery Watermarking Common Class
 *
...
class FTGallery_Create_Image {
	...
	public function __construct() {
		...
		add_filter( 'ft_gallery_defaults', array( $this, 'defaults' ), 10, 2 );
	...
	public function resize_image( $url, $width = null, $height = null, $crop = true, $align = 'c', $quality = 100, $retina = false, $data = array(), $force_overwrite = false ) {
		...
		// Filter args.
		$args = apply_filters( 'ft_gallery_resize_image_args', $args );
		...
		return apply_filters( 'ft_gallery_resize_image_resized_url', $resized_url );
	...
	/**
	 * Get Instance FT Gallery Watermarking Common
	 *
